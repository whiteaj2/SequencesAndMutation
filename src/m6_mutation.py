...
def run_test(function_to_test: object, argument: object, run_test_number: object,
             correct_returned_value: object,
             correct_argument_value_after_function_call: object) -> object:
    """
